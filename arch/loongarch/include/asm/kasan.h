...
#define XRANGE_SHADOW_SHIFT	(PGDIR_SHIFT + PGD_ORDER + PAGE_SHIFT - 3)
...
/* Cached */
#define XKPRANGE_CC_START		CAC_BASE
...
/* UnCached */
#define XKPRANGE_UC_START		UNCAC_BASE
...
#define XKVRANGE_VC_SIZE		round_up(VMEMMAP_END - VMALLOC_START + 1, PGDIR_SIZE)
