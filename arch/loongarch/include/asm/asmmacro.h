...
#undef v1
	...
	.macro fpu_save_vcsr thread tmp
	movfcsr2gr	\tmp, vcsr16
	stptr.w	\tmp, \thread, THREAD_VCSR
	.endm

	.macro fpu_restore_vcsr thread tmp
	ldptr.w	\tmp, \thread, THREAD_VCSR
	movgr2fcsr	vcsr16, \tmp
	.endm
