...
/* For LoongArch, the dma_spec.args[0] is mask, dma_spec.args[1] is value */
#define SEL_MASK_SHIFT(mask)	(~(mask))			/* clear the mask */
#define SEL_VAL(nr, sel) 	(nr)				/* set new value */
#else
